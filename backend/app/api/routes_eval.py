...
@router.post("/benchmark", response_model=BenchmarkRunResponse, dependencies=[Depends(verify_api_key)])
...
@router.post("/performance-benchmark", response_model=PerformanceBenchmarkResponse, dependencies=[Depends(verify_api_key)])
